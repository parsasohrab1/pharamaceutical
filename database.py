"""Database models and session helpers for HQCA enterprise features."""
...
DATABASE_URL = os.getenv("HQCA_DATABASE_URL", f"sqlite:///{DEFAULT_SQLITE_PATH}")
...
class ProcessingTask(Base):
    ...
    output_metrics_object: Mapped[str | None] = mapped_column(String(255), nullable=True)
